...
def index(request):
    ...
    return render(request, 'the-gram/index.html', params)
...
def profile(request, username):
    ...
    return render(request, 'the-gram/profile.html', params)
...
def user_profile(request, username):
    ...
    print(followers)
    return render(request, 'the-gram/user_profile.html', params)
...
def post_comment(request, id):
    ...
    return render(request, 'the-gram/single_post.html', params)
...
def like_post(request):
    ...
    if request.is_ajax():
        html = render_to_string('the-gram/like_section.html', params, request=request)
